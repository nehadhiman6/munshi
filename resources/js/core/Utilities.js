...
class Utilities {
    ...
    static formatNumber(number, places = 3, curr_sym = "",comma = '') {
        return accounting.formatMoney(Utilities.round(number), curr_sym, places, comma, ".");
    }
...
static setProperCase(str) {
    ...
    static joinArraytoString(arr,join_term= ', ', add_and = true) {
