<template>
   <component :is="componentInstance"
        caption="Letters to Utilities (Gas Department)"
        :file-name="'letters_to_utilities_gas_department'+file_opening.file_no"
        ...
        getContent:function(){
            ...
            if(depts) {
                depts.forEach((element,index) => {
                    if(element.department_type.toUpperCase() == 'GAS') {
                        dept = element;
                    }
                })
            }
