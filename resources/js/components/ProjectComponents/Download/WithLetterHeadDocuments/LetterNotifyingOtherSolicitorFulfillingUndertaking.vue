<template>
     <component :is="componentInstance"
        caption="Letter notifying other solicitor fulfilling undertaking"
         :file-name="'letter_notifying_other_solicitor_fulfilling_undertaking'+file_opening.file_no"
        :content="content"
            ...
            section.push({
                ...
                children: [
                    ...
                    new Paragraph({
                        children: [
                                new TextRun({
                                    text: "Further to the undertaking which I delivered on the closing of the above transaction, I wish to advise that a discharge of mortgage No. PR1234569 in favour of 12345 Financial Corporation Inc. was registered on February 25, 2021 as Instrument No. PR12345.",
                                    break:2
                                }),
                                new TextRun({
                                    text: "It is confirmed that  this completes this matter, as this fulfils the undertaking provided on closing.",
                                    break:2
                                }),
