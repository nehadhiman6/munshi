<template>
    ...
    :file-name="'solicitor_affidavit_execution'+file_opening.file_no"
        caption="Solicitor affidavit execution"
        :content="content">
    </document-without-letter-head>
                ...
                children: [
                    ...
                    new Paragraph({
                        children: [
                                ...
                                new TextRun({
                                    text: 'certain Writs of Execution in the hands of the Sheriff of the Regional Municipality of Peel, copies of which have been filed in the Peel Land Registry (NO. 43) as Number(s): 19-00000000',
                                }),
                    ...
                    new Paragraph({
                        children: [
                            ...
                            new TextRun({
                                text: 'I, '+def_solicitor+', solemnly declare that:',
                            }),
                    ...
                    new Paragraph({
                        children: [
                            new TextRun({
                                text: "I am the solicitor for Seller ONE, a registered owner of the lands entered as ,",
                            }),
                    ...
                    new Paragraph({
                        children: [
                            new TextRun({
                                text: 'The said abc sira singh, is not the same person as Satnam Singh Gothra, the judgment debtor named in Writ of Execution Number 19-00000000 wherein Royal Bank of Canada, as Plaintiff, was awarded the sum of $30601.05 plus costs of $nil.',
                            }),
                    ...
                    new Paragraph({
                        children: [
                            new TextRun({
                                text: 'The '+def_solicitor+' shall indemnify and save harmless '+def_solicitor+', Barrister and Solicitor from and against any, all actions, proceedings claims, demands, obligations or liabilities against the '+def_solicitor+' if he/she is found one and the same person, and hit covenant shall survive the closing of this transaction.',
                            }),
                    ...
                    new Paragraph({
                        children: [
                            ...
                            new TextRun({
                                text: "this          day of "+moment().format('MMMM, YYYY')+".\t\t } " + "  \t"+def_solicitor,
                                break:1
                            }),
                            new TextRun({
                                text: "\t\t\t\t\t }",
