<template>
     <component :is="componentInstance"
        caption="Fax Coversheet to lawyer"
  ...
  mounted:function(){
    ...
    methods:{
        ...
        getContent:function(){
            ...
            var pur_solicitor = self.file_opening.purchaser_solicitor && self.file_opening.purchaser_solicitor.solicitor ? self.file_opening.purchaser_solicitor.solicitor:null;
                ...
                children: [
                    ...
                    new Paragraph({
                        children: [
                            ...
                            new TextRun({
                                text: pur_solicitor ? pur_solicitor.name:'',
                                break:1,
                            }),
                            new TextRun({
                                text: 'Address: '+(pur_solicitor && pur_solicitor.address ? pur_solicitor.address.addr_line1+' '+pur_solicitor.address.addr_line2:''),
                                break:1,
                            }),
                            new TextRun({
                                text: 'Fax: '+(pur_solicitor ? pur_solicitor.fax:''),
                                break:1,
                            }),
                        ],
                        spacing: {
