<template>
    <component :is="componentInstance"
        caption="Fax Coversheet to Bank"
        :file-name='"Fax cover Purchasers Lawyer"'
...
export default {
    ...
    methods:{
        ...
        getContent:function(){
            ...
            var mortgagee = self.file_opening.mortgages  ? self.file_opening.mortgages[0]:null;
                ...
                children: [
                    ...
                    new Paragraph({
                        children: [
                            ...
                            new TextRun({
                                text: mortgagee && mortgagee.mortgagee ? mortgagee.mortgagee.company_name:'',
                                break:1,
                            }),
                            new TextRun({
                                text: 'Address: '+(mortgagee && mortgagee.address ? mortgagee.address.addr_line1+' '+mortgagee.address.addr_line2:''),
                                break:1,
                            }),
                            new TextRun({
                                text: 'Fax: '+(mortgagee && mortgagee.mortgagee ? mortgagee.mortgagee.fax:''),
                                break:1,
                            }),
                        ],
                        spacing: {
                    ...
                    new Paragraph({
                        children: [
                            ...
                            new TextRun({
                                text: '\t\t\t\tLoan Number:' + '\t ' + (mortgagee ? mortgagee.instrument_no:''),
                                break:1
                            }),
                            new TextRun({
