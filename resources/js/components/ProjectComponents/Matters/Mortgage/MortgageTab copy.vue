        ...
        <div class="form-horizontal">
                <div class="card-body">
                     ...
                     <div class = "form-row">
                         ...
                         <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" v-bind:class="{ 'is-invalid': form.errors.get('mortgages.'+index+'.principal_amount') }" type="text" v-model ="mortgage.principal_amount">
                                <span id="basic-msg" v-if="form.errors.get('mortgages.'+index+'.principal_amount')" class="invalid-feedback">{{ form.errors.get('mortgages.'+index+'.principal_amount') }}</span>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="principal_amount" class="in-label-title ml-5 mt-4"> ${{mortgage.principal_amount}}.00 </label>
                            </div>
                        </div>
                    ...
                    <fieldset class="fieldset">
                        ...
                        <mortgage-charge v-for="(charge,index) in mortgage.additional_charges" :key="charge.random"
                            :index='index'
                            :charge='charge'
                            :form="form"
                      ...
                      <div class = "form-row">
                        <div class="col-md-3 offset-9">
                            ...
                            <input class="form-control" v-bind:class="{ 'is-invalid': form.errors.get('mortgages.'+index+'.total') }" type="text" disabled  v-model ="total_charge">
                         ...
                         <div class="col-md-3">
                            <div class="form-group" v-bind:class="{ 'is-invalid': form.errors.get('mortgages.'+index+'.mortgagee_id') }">
                                <label for="mortgagee_id" class="in-label-title ">Mortgagee</label>
                                    <contact-select v-if="show" v-model="mortgage.mortgagee_id" :initials="initialContact" :selected="selectedContact" type="mortgagee"
                                       @updateContact="getContactAddress" :index="form.random"></contact-select>
...
export default {
  components: { EmployeeSelect, CityForm, SolicitorSelect, MortgageCharge },
    ...
    mounted:function(){
        ...
        if(this.mortgage.mortgagee){
            ...
            this.initialContact = [{'text':this.mortgage.mortgage.company_name}];
